...
└── assets/                  # 🖼️ 고화질 2D 스프라이트 에셋
    ├── hero.png, door.png, floor.png
    ├── wumpus.png, pit.png, gold.png, giltter.png
    └── breeze.png, stench.png, scream.png, arrow.png
```
...
| `assets/`              | 🎨 던전 타일, 캐릭터, 몬스터, 함정, 지각 신호(아이콘) 스프라이트 리소스                           |
